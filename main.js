...
classifier = ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/6LNUxciW0/model.json",modelLoaded);
...
function speak_pre(){
    var speaking = window.speechSynthesis;
    var dontspeakthis = "PREDICTION 1 "+prediction1;
    var dontspeakthis2 = "PREDICTION 2 "+prediction2;
...
function gotResult(error,results){
    if(error){
        alert("very sorry to say, an error occoured "+error+"     PLEASE RETRY");
    }else{
        console.log(results)
